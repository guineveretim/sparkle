...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            form.save()
            # You can add a success message or redirect after saving
            return redirect('thankyou')  # Replace with your URL name
    else:
        form = ContactUsForm()
...
def thankyou(request):
    return render(request, 'application/thankyou.html')
